...
export const words = [
  "ALBUM", "HINGE", "MONEY", "SCRAP", "GAMER", "GLASS", "SCOUR", "BEING", "DELVE", "YIELD", "METAL", "TIPSY", "SLUNG", "FARCE", "GECKO",
  ...
  "SERVE", "NAVAL", "EVADE", "FOCAL", "BLUSH", "AWAKE", "HUMPH", "SISSY", "REBUT", "CIGAR", "HELLO"
];

export const correctGuess = words[Math.floor(Math.random() * words.length)];